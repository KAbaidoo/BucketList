...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.EventViewHolder> {
...
//        OnItemSelectedListener listener;
    ...
    @Override
    public void onBindViewHolder(SearchAdapter.EventViewHolder holder, int position) {
